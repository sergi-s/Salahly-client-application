...
29.919915
  ...
  */
  ...
  static getNearbyMechanics(double lat,double long, double radius,Ref ref) async {
  ...
  static getNearbyProviders(double lat,double long, double radius,Ref ref) async {
